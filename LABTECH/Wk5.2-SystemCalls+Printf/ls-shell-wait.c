...
{
  // Ryan Edwards;
  // pid_t creates a process ID that is used to identify a running process
    pid_t child_pid;
    pid_t finished;
    int   child_status;
    ...
    // fork() is used to create a child process; the total number of processes is equal to 2^n, where
    // n is the number of forks that happen
